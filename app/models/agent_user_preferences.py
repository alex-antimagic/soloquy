...
class AgentUserPreferences(db.Model):
    ...
    # Relationships
    user = db.relationship('User', foreign_keys='[AgentUserPreferences.user_id]', backref='agent_preferences')
    agent = db.relationship('Agent', foreign_keys='[AgentUserPreferences.agent_id]', backref='user_preferences')
